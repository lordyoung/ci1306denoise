...
/******************************** sdk config *********************************/
#define MERGE_OFFLINE_SDK_VERSION     "1.12.7"
// SDK VER
#define SDK_VERSION                    2
#define SDK_SUBVERSION                 1
#define SDK_REVISION                   7
#define SDK_TYPE                       "ALG_RTC"
...
#define GS0XJ_BOARD_PA_AUTO             1      //GS0XJ系列板子PA是否开启自动检测功能。0、关闭（默认低电平有效）。1、开启。    
#endif
...
#define USE_DENOISE_NN                 0    //如果要使用深度学习降噪，请注意调整lds（两个lds，NN map都要调整）
#endif

/*单MIC 深度学习降噪（通话降噪）*/
#ifndef USE_DENOISE_NN_RTC
#define USE_DENOISE_NN_RTC            0    //如果要使用深度学习降噪，请注意调整lds（两个lds，NN map都要调整）
#endif
...
/*自动增益控制 AGC*/
#ifndef USE_AGC_MODULE
#define USE_AGC_MODULE                 0    
#endif
/*啸叫抑制 AHS*/
...
#define VP_THR_FOR_MATCH                    (0.58f)//声纹阈值
#endif
...
/*********************** 使用外部IIS输入语音进行识别 *************************/
    ...
    #if USE_DENOISE_NN
    #define AUDIO_IN_BUFFER_NUM (12)//只为DENOISE_NN留这么多
    #else
...
//使用IIS输出算法处理之后的语音
#ifndef USE_IIS0_OUT_PRE_RSLT_AUDIO
