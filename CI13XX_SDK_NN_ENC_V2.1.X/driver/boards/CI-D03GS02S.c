...
{
    #if AUDIO_PLAYER_ENABLE || USE_HP_OUT_PRE_RSLT_AUDIO || USE_UART_SEND_PRE_RSLT_AUDIO || USE_IIS0_AUDIO_IN_SPEAKER_OUT
    .IICx = IIC_NULL,
...
void audio_pre_rslt_out_codec_init_pa_out(void)
{
    ...
    uint16_t block_size = AUDIO_CAP_POINT_NUM_PER_FRM * 2 * sizeof(int16_t);
    mprintf("3------audio_pre_rslt_out_codec_init_pa_out..\r\n");
